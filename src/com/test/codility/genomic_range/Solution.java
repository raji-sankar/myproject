package com.test.codility.genomic_range;
/*
...
public class Solution {
    public int[] solution(String S, int[] P, int[] Q){
        ...
        for(int i=0; i<P.length; i++){
            int begin = P[i];
            int end = Q[i] + 1;
            if (genomes[0][end] - genomes[0][begin] > 0){
                result[i] = 1;
            } else if(genomes[1][end] - genomes[1][begin] > 0){
                result[i] = 2;
            } else if (genomes[2][end] - genomes[2][begin] > 0){
                result[i] = 3;
            } else {
                result[i] = 4;
            }
